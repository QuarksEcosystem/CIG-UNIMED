...
from PipelineFunctions.dicionarioCaracteresEspeciais import replace_pairs, replace_dict


# @TimeExecution
def trataCaracteresEspeciais(session:Session,
                             database:str,
                             schema:str,
                             warehouse:str,
                             table:str,
...
#     print("Selecting database, warehouse and schema...")
    ...
    specialCharReplace = session.udf.register(
                             lambda txt: txt.translate(replace_dict).upper(),
                             packages=["unidecode"],
